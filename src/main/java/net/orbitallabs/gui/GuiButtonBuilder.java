...
public class GuiButtonBuilder extends GuiButton {
	...
	public void drawButton(Minecraft mc, int x, int y, float ticks)
	{
		...
		if (this.visible)
		{
			...
			this.hover = x >= this.x && y >= this.NyPos && x < this.x + this.width && y < this.NyPos + this.height;
			...
			{
				this.drawTexturedModalRect(this.x, this.NyPos, 0, 167, this.width, this.height);// normal
			} else if (pressed)
			{
				this.drawTexturedModalRect(this.x, this.NyPos, 0, 207, this.width, this.height);// pressed
			} else if (getHoverState(this.hover) == 2 && !pressed)
			{
				this.drawTexturedModalRect(this.x, this.NyPos, 0, 187, this.width, this.height);// hover
			} else this.drawTexturedModalRect(this.x, this.NyPos, 0, 167, this.width, this.height);// normal
			...
			if (len <= 55)
			{
				fontrenderer.drawString(this.displayString, this.x + 20, this.NyPos + this.height - 12, l, false);
			} else
			{
				String part2 = "";
				...
				fontrenderer.drawString(tokens[0], this.x + 20, this.NyPos + this.height - 19, l, false);
				if (!part2.equals(""))
				{
					fontrenderer.drawString(part2, this.x + 20, this.NyPos + this.height - 11, l, false);
				}
			}
		}
	}
	...
	public void renderIcons()
	{
		...
		if (GuiBuilder.AstG.size() != 0)
		{
			...
			{
				DrawGuiIcon(this.x + 2, this.NyPos + 2, "hall", 0);
			} else if (GuiBuilder.AstG.containsKey(Structure.CORNERID) && id == (int) GuiBuilder.AstG.get(Structure.CORNERID))
			{
				if (dir == EnumFacing.WEST)
				{
					if (rot == 0)
					{
						DrawGuiIcon(this.x + 2, this.NyPos + 2, "corner", 0);
					} else if (rot == 1)
					{
						DrawGuiIcon(this.x + 2, this.NyPos + 2, "corner", 1);
					}
			...
			} else if (GuiBuilder.AstG.containsKey(Structure.THALLID) && id == (int) GuiBuilder.AstG.get(Structure.THALLID))
			{
				if (dir == EnumFacing.WEST)
				{
					if (rot == 0)
					{
						DrawGuiIcon(this.x + 2, this.NyPos + 2, "thall", 3);
					} else if (rot == 1)
					{
						DrawGuiIcon(this.x + 2, this.NyPos + 2, "thall", 2);
					} else if (rot == 2)
					{
						DrawGuiIcon(this.x + 2, this.NyPos + 2, "thall", 1);
					}
				} else if (dir == EnumFacing.EAST)
				{
					if (rot == 2)
	...
	{
		return this.enabled && this.visible && x >= this.x && y >= this.NyPos && x < this.x + this.width && y < this.NyPos + this.height;
	}
