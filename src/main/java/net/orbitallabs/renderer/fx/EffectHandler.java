...
import micdoodle8.mods.galacticraft.core.client.fx.ParticleOilDrip;
...
public class EffectHandler {
	public static void spawnParticle(String particleID, Vector3 position, Vector3 motion, Object... otherInfo)
	{
		...
		if (mc != null && mc.getRenderViewEntity() != null && mc.effectRenderer != null)
		{
			...
			{
				particle = new EntityFXLaunchSmallFlame(mc.world, position, motion, true, (EntityLivingBase) otherInfo[0]);
			} else if (particleID.equals("whiteSmokeIdle"))
			{
