...
public class ModelSnake extends ModelBase {
	...
	protected float[][] undulationCycle = new float[][] { { 45F, -45F, -45F, 0F, 45F, 45F, 0F, -45F }, { 0F, 45F, -45F, -45F, 0F, 45F, 45F, 0F },
			{ -45F, 90F, 0F, -45F, -45F, 0F, 45F, 45F }, { -45F, 45F, 45F, 0F, -45F, -45F, 0F, 45F }, { 0F, -45F, 45F, 45F, 0F, -45F, -45F, 0F },
	...
	{
		renderSerpent((EntitySnake) parEntity, parTime, parSwingSuppress, par4, parHeadAngleY, parHeadAngleX, par7);
	}
	
	public void renderSerpent(EntitySnake parEntity, float parTime, float parSwingSuppress, float par4, float parHeadAngleY, float parHeadAngleX, float par7)
	{
	...
	{
		// animate if moving  
		EntitySnake snake = (EntitySnake) parEntity;
		updateDistanceMovedTotal(snake);
		cycleIndex = (int) ((getDistanceMovedTotal(snake) * 0.5) % undulationCycle.length);
		// DEBUG
		System.out.println("ModelSerpent setRotationAngles(), distanceMoved =" + getDistanceMovedTotal(snake) + ", cycleIndex =" + cycleIndex + ", tempreture ="
				+ ((EntitySnake) parEntity).bodyTempreture);
	...
	protected void updateDistanceMovedTotal(EntitySnake parEntity)
	{
		parEntity.distanceMovedTotal += parEntity.getDistance(parEntity.prevPosX, parEntity.prevPosY, parEntity.prevPosZ);
	}
	
	protected double getDistanceMovedTotal(EntitySnake parEntity)
	{
		return (parEntity.distanceMovedTotal);
	}
