...
public class ChannelEnable extends Channel {
	public ChannelEnable(String _name, float _fps, int _totalFrames, byte _mode)
	{
	...
	/*	KeyFrame frame2 = new KeyFrame();
		...
		frame7.modelRenderersRotations.put("rightarm", new Quaternion(0.5983246F, 0.0F, 0.0F, 0.8012538F));
		frame7.modelRenderersRotations.put("leftarm", new Quaternion(0.5983246F, 0.0F, 0.0F, 0.8012538F));
		...
		frame9.modelRenderersRotations.put("ControlLast1", new Quaternion(0.70710677F, 0.0F, 0.0F, 0.70710677F));
		frame9.modelRenderersRotations.put("ControlHand2", new Quaternion(4.371139E-8F, -4.371139E-8F, 1.0F, 1.9106855E-15F));
	//	frame9.modelRenderersRotations.put("rightarm", new Quaternion(0.43837115F, 0.0F, 0.0F, 0.89879405F));
		frame9.modelRenderersRotations.put("ControlLast2", new Quaternion(0.70710677F, 0.0F, 0.0F, 0.70710677F));
		frame9.modelRenderersRotations.put("ControlFrist2", new Quaternion(-0.70710677F, 0.0F, 0.0F, 0.70710677F));
		frame9.modelRenderersRotations.put("ControlHand1", new Quaternion(4.371139E-8F, -4.371139E-8F, 1.0F, 1.9106855E-15F));
		frame9.modelRenderersRotations.put("ControlFrist1", new Quaternion(-0.70710677F, 0.0F, 0.0F, 0.70710677F));
		//frame9.modelRenderersRotations.put("leftarm", new Quaternion(0.43837115F, 0.0F, 0.0F, 0.89879405F));
		frame9.modelRenderersTranslations.put("ControlLast1", new Vector3f(-5.0F, -6.0F, 7.0F));
		frame9.modelRenderersTranslations.put("ControlHand2", new Vector3f(5.0F, -4.0F, -3.0F));
		//frame9.modelRenderersTranslations.put("rightarm", new Vector3f(-5.0F, 0.0F, 2.0F));
		frame9.modelRenderersTranslations.put("ControlLast2", new Vector3f(5.0F, -6.0F, 7.0F));
		frame9.modelRenderersTranslations.put("ControlFrist2", new Vector3f(5.0F, -6.0F, 1.0F));
		frame9.modelRenderersTranslations.put("ControlHand1", new Vector3f(-5.0F, -4.0F, -3.0F));
		frame9.modelRenderersTranslations.put("ControlFrist1", new Vector3f(-5.0F, -6.0F, 1.0F));
		//frame9.modelRenderersTranslations.put("leftarm", new Vector3f(5.0F, 0.0F, 2.0F));
