...
public class SkyProviderMarsSpaceStation extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderMarsSpaceStation.sunTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMarsSpaceStation.overworldTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		...
		if (this.planetToRender != null)
		{
			...
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(this.planetToRender);
